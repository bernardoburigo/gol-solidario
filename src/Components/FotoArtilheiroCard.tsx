...
export default function FotoArtilheiroCard({ isDesktop }: Props) {
  if (!fotosData.fotoArtilheiro?.url) return null;
  return (
    <div
      className={`
        w-full
    ...
    >
      ...
      >
        <img
          src={fotosData.fotoArtilheiro.url}
          alt={fotosData.fotoArtilheiro.alt}
